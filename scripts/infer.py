...
if __name__ == "__main__":
    ...
    for sets in os.listdir(sys.argv[2]):
        os.mkdir(sys.argv[3]+"/"+sets)
        for v in os.listdir(sys.argv[2]+"/"+sets):
            os.mkdir(sys.argv[3]+"/"+sets+"/"+v)
            for img in os.listdir(sys.argv[2]+"/"+sets+"/"+v+"/visible/"):
                evaluate(cfg_path, model_path, sys.argv[2]+"/"+sets+"/"+v+"/visible/"+img, sys.argv[3]+"/"+sets+"/"+v+"/"+img)
